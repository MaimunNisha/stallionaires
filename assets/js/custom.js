...
jQuery('.next-slide').on('mouseenter', function () {
...
function navsliderowner(data) {
  console.log(data.firstElementChild);
  document.querySelector("#ownername").innerText = data.children[0].value;
  document.querySelector("#ownerposition").innerText = data.children[1].value;
